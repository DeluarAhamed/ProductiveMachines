...
const ASSETS = {
  hero: {
    cycle: 'https://productivemachines.co.uk/images/Reduce_cycle_times.webp',
    eliminate: 'https://productivemachines.co.uk/images/Eliminate.webp',
    tool: 'https://productivemachines.co.uk/images/Extend_tool_life.webp',
  },
  tapStarter: 'https://productivemachines.co.uk/images/tap_starter_home.webp',
  newsletter: 'https://productivemachines.co.uk/images/CAM_engineer_AdobeStock_145477262 1.png',
  ...
  partners: [
    { name: 'Boeing', src: 'https://productivemachines.co.uk/images/clients/11.png', whiteBg: true },
    { name: 'AE HorizonX', src: 'https://productivemachines.co.uk/images/clients/AE-HorizonX-Logo.png', whiteBg: false },
    { name: 'MSP', src: 'https://productivemachines.co.uk/images/msp-logo.png', whiteBg: true },
    { name: 'MachineWorks', src: 'https://productivemachines.co.uk/images/MachineWorks logo 15cm.png', whiteBg: true, scale: 1.85 },
    { name: 'Aerospace Accelerated', src: 'https://productivemachines.co.uk/images/clients/Aerospace Accelarated.png', whiteBg: true },
    { name: 'Siemens', src: 'https://productivemachines.co.uk/images/clients/22.png', whiteBg: true },
    { name: 'AMRC', src: 'https://productivemachines.co.uk/images/clients/14.png', whiteBg: true },
    { name: 'Sandvik', src: 'https://productivemachines.co.uk/images/clients/15.png', whiteBg: true },
    { name: 'UKISF', src: 'https://productivemachines.co.uk/images/clients/17.png', whiteBg: true },
    { name: 'Seco Tools', src: 'https://productivemachines.co.uk/images/Seco Logo RGB Full Color (3).png', whiteBg: true },
    { name: 'Digital Catapult', src: 'https://productivemachines.co.uk/images/clients/21.png', whiteBg: false },
  ],
  blog: [
    { tag: 'News', date: 'Jul 2025', img: 'https://productivemachines.co.uk/images/MP-Visit-July-2025-Manufacturing-Innovation.jpg', title: 'Sarah Champion MP Visits to Witness Cutting-Edge Manufacturing Innovation', text: 'Sarah Champion, MP for Rotherham, visited Productive Machines to learn about the company\'s transformative impact on UK manufacturing and experience SenseNC™ firsthand.', href: 'news.html#sarah-champion-visit', slug: 'sarah-champion-visit' },
    { tag: 'Blog', date: 'Oct 2025', img: 'https://productivemachines.co.uk/images/blog/mic-2025.png', title: 'Innovations in Aerospace Manufacturing and Key Takeaways', text: 'The 24th Machining Innovations Conference (MIC 2025) highlighted aerospace manufacturing advancements in sustainability, digitalization, and AI.', href: 'news.html#mic-2025', slug: 'mic-2025' },
    { tag: 'Case study', date: 'Aug 2025', img: 'https://productivemachines.co.uk/images/AML_entrance.png', title: 'AML\'s Success with Productive Machines', text: 'By maximising the efficiency of machine tools, Productive Machines empowers machinists to achieve superior quality parts faster and with greater precision.', href: 'case-studies.html#aml', slug: 'aml-case-study' },
  ],
};
